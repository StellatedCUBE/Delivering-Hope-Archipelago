...
dh_locations = [
	*(
		...
		for i, (name, default, *requirements) in enumerate(
			(
				("Hope has Ascended", True, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, DHObject.JETPACK, DHAbility.DOWNBOOST),
				("See The World", True, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), 5000),
				("Hope is in the Air", True),
				("Free Yeets", True, DHObject.MORI),
				("Bounce and Fly", True, DHObject.BANANA),
				("Gliding Hope", True),
				("High Hope", True, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, DHObject.JETPACK, DHAbility.DOWNBOOST),
				("Long Range Hope", True, 1160),
				("Meatball-chan", True),
				("Sweet Nectar", True),
				("Third Time's the Charm", True),
				("Unlimited Yeet Works", True, DHObject.MORI, DHAbility.DOWNBOOST),
				...
				("Gravity", True),
				("Till the End of Me", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), (DHObject.GURA, DHObject.FAUNA, DHObject.INA), DHAbility.DOWNBOOST, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 20000),
				("Caesura of Despair", True, DHObject.MORI, DHObject.MUMEI, DHObject.KRONII, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), DHAbility.DOWNBOOST, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 100000),
				("Berserker", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 80000),
				("HERE COMES HOPE", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 60000),
				("Flower of hope", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 40000),
				("One Step at a Time", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 30000),
				("Antigravity", True, DHRegion.BAELESS, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, DHObject.JETPACK, DHAbility.DOWNBOOST),
				("Unstoppable", True, DHRegion.BAELESS, DHObject.MORI, DHAbility.DOWNBOOST),
				...
				("A whole new HOPE", True, DHPowerUp.REBIRTH),
				("Zooming HOPE", True, DHObject.JETPACK, DHObject.MORI, DHAbility.DOWNBOOST, DHObject.MONOPOLY),
				("Hot Wings", True, DHObject.KIARA, DHAbility.DOWNBOOST),
				("Holy Shitto", True, DHRegion.BAELESS, DHObject.MORI, DHAbility.DOWNBOOST),
				("Civilization", True, DHRegion.BAELESS, DHObject.MUMEI, DHAbility.DOWNBOOST),
				("GWAK!?", True, DHRegion.BAELESS, DHObject.KRONII, DHAbility.DOWNBOOST),
				("SPARKS", True, DHRegion.BAELESS, DHObject.KIARA, DHAbility.DOWNBOOST),
				("Tokyo Tower", False, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, DHObject.JETPACK, DHAbility.DOWNBOOST, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS)),
				...
				("you, sleb", False),
				("Fun game", False),
				("Well equipped", True, (*DHRecipe,), DHAbility.LAB),
				("Potionmaker", True, (*DHRecipe,), DHAbility.LAB),
				...
				("Daredevil", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 10000),
				("Boost and Bonk", True, DHAbility.DOWNBOOST, (DHObject.MUMEI, DHObject.KRONII)),
				("Supersonic", True, DHObject.JETPACK, DHAbility.DOWNBOOST, DHObject.KIARA, DHObject.MORI, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), DHObject.MONOPOLY, DHAbility.BEACH),
				("Hypersonic", True, DHObject.JETPACK, DHAbility.DOWNBOOST, DHObject.KIARA, DHObject.MORI, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), DHObject.MONOPOLY, DHAbility.BEACH),
				("I need it", True),
				...
				("Luck and Skill", True, DHRegion.BAELESS, DHObject.JETPACK, DHObject.MORI, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 7000),
				("Oh hi", True, DHRegion.BAELESS, DHAbility.DOWNBOOST, DHObject.MUMEI),
				("Feeling Lucky", True, DHRegion.GACHA, DHObject.MORI, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 5000),
				("Incredible Luck!", True, DHRegion.GACHA, DHObject.MORI, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), 15000),
				("Sixth sense", True, DHRegion.GACHA),
				("Perfect Yeet!", False),
				("Beyond the Clouds", True, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, DHObject.JETPACK, DHAbility.DOWNBOOST),
				("DizzyRyS", True, DHObject.GURA, DHAbility.BEACH),
				("Inaception", True, DHObject.INA, DHAbility.BEACH, DHAbility.DOWNBOOST),
				("Choo Choo!", True, DHRegion.BAELESS, DHObject.MONOPOLY, DHAbility.DOWNBOOST),
				("No Escape", True, DHObject.MONOPOLY),
				("One button only", True, DHAbility.DOWNBOOST, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII)),
				("The Cell", True, DHRegion.BAELESS, DHObject.MORI, 3000),
	...
	*(
		DHLocation(DHLocationType.SHOP, i + 6, f"Shop item {i + 1}", True, [DHAbility.SHOP])
		for i in range(7)
	),
	*(
	...
	*(
		DHLocation(DHLocationType.FUSION, i, name, True, [DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.FUSION, DHAbility.DOWNBOOST, (DHPowerUp.RAT_BLOCKER, DHPowerUp.DIVORCE_PAPERS), part1, part2, DHAbility.BEACH if beach else None])
