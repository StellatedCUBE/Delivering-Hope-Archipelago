...
dh_locations = [
	*(
		...
		for i, (name, default, *requirements) in enumerate(
			(
				...
				("Gravity", True),
				("Till the End of Me", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), (DHObject.GURA, DHObject.FAUNA, DHObject.INA), DHAbility.DOWNBOOST, 20000),
				("Caesura of Despair", True, DHObject.MORI, DHObject.MUMEI, DHObject.KRONII, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), DHAbility.DOWNBOOST, 100000),
				("Berserker", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), 80000),
				("HERE COMES HOPE", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), 60000),
				("Flower of hope", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), 40000),
				("One Step at a Time", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, (DHObject.GURA, DHObject.FAUNA, DHObject.INA), 30000),
				...
				("Zooming HOPE", True, DHObject.JETPACK, DHObject.MORI, DHAbility.DOWNBOOST),
				...
				("Tokyo Tower", True, (DHObject.MUMEI, DHObject.KRONII), DHObject.MORI, DHObject.JETPACK, DHAbility.DOWNBOOST),
				...
				("Daredevil", True, DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.DOWNBOOST, 10000),
				("Boost and Bonk", True, DHAbility.DOWNBOOST, (DHObject.MUMEI, DHObject.KRONII)),
				("Supersonic", True, DHObject.JETPACK, DHAbility.DOWNBOOST, DHObject.KIARA, DHObject.MORI),
				("Hypersonic", True, DHObject.JETPACK, DHAbility.DOWNBOOST, DHObject.KIARA, DHObject.MORI),
				("I need it", True),
				...
				("Luck and Skill", True, DHRegion.BAELESS, DHObject.JETPACK, DHObject.MORI, 7000),
				("Oh hi", True, DHRegion.BAELESS, DHAbility.DOWNBOOST, DHObject.MUMEI),
				("Feeling Lucky", True, DHRegion.GACHA, DHObject.MORI, 5000),
				("Incredible Luck!", True, DHRegion.GACHA, DHObject.MORI, 15000),
	...
	*(
		DHLocation(DHLocationType.FUSION, i, name, True, [DHObject.MORI, (DHObject.MUMEI, DHObject.KRONII), DHAbility.FUSION, DHAbility.DOWNBOOST, part1, part2, DHAbility.BEACH if beach else None])
